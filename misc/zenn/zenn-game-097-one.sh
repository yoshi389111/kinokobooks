...
create_pages 101 197
rm -f "$METAFILE"

sed -i -e '/<table/,/<\/table/d' "$OUTDIR/game-181.md"
echo "![](https://github.com/yoshi389111/kinokobooks/blob/main/misc/zenn/game-181-table.png?raw=true)" >> "$OUTDIR/game-181.md"
