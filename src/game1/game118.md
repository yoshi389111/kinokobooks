...
　ナムコでいくつかのプロジェクトを経験した後、声をかけられたプロジェクトがあった。既存IPの名前を借りつつも、その成果物でチームブランドを作ろうという大変意欲的なもので、私はそこで光栄にもチーフデザイナを任された。しかし私は、品質へのこだわりと生産性の折り合いをつけられず、予算面からプロデューサーと対立した。最終的に私はプロデューサーに暴言を吐き、結果、チームを抜けることとなった。
